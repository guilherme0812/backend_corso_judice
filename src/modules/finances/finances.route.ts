...
export const financesRoutes = async (fastify: FastifyInstance) => {
    ...
    fastify.get('/finances/payments', { preHandler: authMiddleware }, (financesController.getPayments as any).bind(financesController));
    fastify.get('/finances/cashflow', { preHandler: authMiddleware }, (financesController.getCashFlow as any).bind(financesController));
    fastify.get('/finances/monthly', { preHandler: authMiddleware }, (financesController.monthlyReport as any).bind(financesController));
};
